                    ...
                    @foreach ($category->posts as $post)
                        <article class="brick entry" data-aos="fade-up">
                            ...
                            <div class="entry__thumb">
                                <a href="{{ route('posts-slug.view', $post->slug) }}" class="thumb-link">
                            ...
                            <div class="entry__text">
                                <div class="entry__header">
                                    <h1 class="entry__title textTruncateOne" data-toggle="tooltip"
                                        title="{{ $post->title }}"><a
                                            href="{{ route('posts-slug.view', $post->slug) }}">{{ $post->title }}</a></h1>
                                ...
                                <div class="entry__excerpt cardTextSize textTruncateTwo ">
                                    <p class="textTruncateTwo">
                                        {{ $post->excerpt }}
                                    </p>
                                </div>
