...
@section('breadcrumb')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Privacy Add</li>
        </ol>
    </div><!-- /.col -->
@endsection
@section('content')
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="title">Privacy Body </label>
                                <textarea id="policy_body" name="body" class=" form-control" rows="4" required></textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
